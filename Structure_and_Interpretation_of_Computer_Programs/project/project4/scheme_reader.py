...
def scheme_read(src):
    ...
    if val == 'nil':
        ...
        return nil
        # END PROBLEM 1
    elif val == '(':    # a pair or a list, call read_tail
        # BEGIN PROBLEM 1
        "*** YOUR CODE HERE ***"
        return read_tail(src)
        # END PROBLEM 1
    elif val == "'":    # a quote expression
        # BEGIN PROBLEM 6
        "*** YOUR CODE HERE ***"
...
def read_tail(src):
    ...
    try:
        ...
        elif src.current() == ')':  # end of a pair/list, remove token and return nil
            # BEGIN PROBLEM 1
            "*** YOUR CODE HERE ***"
            src.pop_first()
            return nil
            # END PROBLEM 1
        else:   # operator in a combination, e.g. + 2 3)
            # BEGIN PROBLEM 1
            "*** YOUR CODE HERE ***"
