...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        while current_place != beehive:
            if current_place.bees and count <= self.max_range and count >= self.min_range:
...
# END Problem 13
    ...
    def __init__(self, armor=1):
        ...
        "*** YOUR CODE HERE ***"
        self.armor = armor
        if not QueenAnt.deployed:
            self.is_true_queen = True
            QueenAnt.deployed = True
        else:
    ...
    def action(self, gamestate):
        ...
        while current_place:
            ...
            if ant and not hasattr(ant, 'doubled'):
                ant.damage = ant.damage * 2
                ant.doubled = True
            if isinstance(ant, ContainerAnt) and ant.contained_ant and not hasattr(ant.contained_ant, 'doubled'):
                ant.contained_ant.damage = ant.contained_ant.damage * 2
